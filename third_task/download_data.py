...
# Каждая запись: (номер формы, дата отчёта YYYYMMDD, какие DBF извлечь)
# Форма 101:
...
# Форма 102:
#   032021B2.DBF — Q1 2021 YTD на 01.04.2021 (для валидации расчёта)
#   062021B2.DBF — Q2 2021 YTD на 01.07.2021
...
DOWNLOADS = [
    ...
    ("102", "20210401"),  # первый квартал 2021
    ("102", "20210701"),  # второй квартал 2021
]
...
def main() -> int:
    ...
    for form, yyyymmdd in DOWNLOADS:
        # Целевое имя DBF внутри архива: MMYYYYB<1|2>.DBF
        yyyy, mm = yyyymmdd[:4], yyyymmdd[4:6]
        suffix = "B1" if form == "101" else "B2"
        main_dbf = f"{mm}{yyyy}{suffix}.DBF"
